function InitSearch(treeViewId, searchInputId, treeviewDropdownBtn, ulTreeViewId) {
...
function InitDropDownTree(idTreeView, UrlOfJsonDataSource, IsloadOnDemand) {
    ...
    InitSearch(idTreeView, searchInputId, treeviewDropdownBtn, ulTreeViewId);
