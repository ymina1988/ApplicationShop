(function () {
    $(function () {
        ...
        $("#searchBala").on("click", function (e) {
            ...
            $.get("/User/UserProfile/GetRelTree", { txtCodeMelli: codeM },
        function (data, textStatus, jqXHR) {

            if (data.Status === "NotAChild") {

                new PNotify({
                    title: 'عملیات ناموفق',
                    text: 'شماره ملی وارد شده جز فرزندان شما نیست. برای مشاهده بالاسری ها، کد ملی وارد شده باید جز فرزندان شما باشد.',
                    type: 'warning',
            ...
            if (data.Status === "NoChildFound") {

                new PNotify({
                    title: 'عملیات ناموفق',
                    text: 'شماره ملی وارد شده یافت نشد.',
                    type: 'warning',
                    icon: 'glyphicon glyphicon-warning-sign',
                    delay: 6000
                });
        ...
        $('body').on('nodeSelected', "#tree", function (event, data) {
            ...
            $.get("/User/UserProfile/GetExtraInfo", { id: data.id },
