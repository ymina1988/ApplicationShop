...
$(function () {
    ...
    $(".idatepicker").addClass("");
    $('.idatepickerfrom').datepicker({
        dateFormat: 'yy/mm/dd',
        onSelect: function (dateText, inst) {
            $('.idatepickerto').datepicker('option', 'minDate', new JalaliDate(inst['selectedYear'], inst['selectedMonth'], inst['selectedDay']));
        }
    });
    $('.idatepickerto').datepicker({
        dateFormat: 'yy/mm/dd',
    });
    // حالت پیشفرض
